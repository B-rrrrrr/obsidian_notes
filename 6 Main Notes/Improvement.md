...
The way this is achieved is by realizing the limits that one has and transcending them, breaking them and overcoming them. Only in such a way can the current self be defeated and be replaced by the winner: a new self that has improved. It is through killing oneself over and over again that progress can be achieved.

In order to improve, current limits must be transcended, and the current self defeated through the transcendence, therefore replacing the limits and the self. 
# References
Why we cringe at our past selves
Page 84 Infinite Jest